  ...
  describe(`tensor/${backend}`, () => {
    ...
    describe('cat', () => {
      it('cat 1d', async () => {
        ...
        const x2 = T.fromArray([5, 6, 7, 8], [4]);
        const y = T.cat([x1, x2]);
      ...
      it('cat 2d 1', async () => {
        const x1 = T.fromArray([1, 2, 3, 4], [2, 2]);
        const x2 = T.fromArray([5, 6, 7, 8], [2, 2]);
        const y = T.cat([x1, x2]);
      ...
      it('cat 2d 3', async () => {
        const x1 = T.fromArray(arange(2 * 3), [2, 3]);
        const x2 = T.fromArray(arange(100, 100 + 2 * 4), [2, 4]);
        const x3 = T.fromArray(arange(200, 200 + 2 * 7), [2, 7]);
        const y = T.cat([x1, x2, x3], 1);
      ...
      it('cat 3d 1', async () => {
        const x1 = T.fromArray(arange(2 * 3 * 4), [2, 3, 4]);
        const x2 = T.fromArray(arange(100, 100 + 2 * 3 * 4), [2, 3, 4]);
        const y = T.cat([x1, x2]);
    ...
    describe('split', () => {
      it('split 1', async () => {
        const x = T.fromArray([1, 2, 3, 4, 5], [5]);
        const y = T.split(x, 3);
      ...
      it('split 2', async () => {
        const x = T.fromArray([1], [1]);
        const y = T.split(x, 10);
        assert.deepEqual(y[0].shape, [1]);
        assert.deepEqual(await y[0].toArrayAsync(), [1]);
      });

      it('split 2d 1', async () => {
        const x = T.fromArray([1, 2, 3, 4], [2, 2]);
        const y = T.split(x, 1, 1);
      ...
      it('split 2d 2', async () => {
        const x = T.fromArray([1, 2, 3, 4, 5, 6], [3, 2]);
        const y = T.split(x, [1, 2]);
      ...
      it('split 3d 1', async () => {
        const x = T.fromArray(arange(100, 100 + 3 * 2 * 4), [3, 2, 4]);
        const y = T.split(x, [1, 2]);
      ...
      it('split 3d 2', async () => {
        const x = T.fromArray(arange(100, 100 + 3 * 4 * 4), [3, 4, 4]);
        const y = T.split(x, [1, 2, 1], 2);
