  ...
  describe('exp', () => {
    ...
    it('exp large', async () => {
      ...
      arrayNearlyEqual(
        await y.toArrayAsync(),
        [
          1.8049e-35, 3.9754e-31, 8.7565e-27, 1.9287e-22, 4.2484e-18,
          9.3576e-14, 2.0612e-9, 4.54e-5, 2.2026e4, 4.8517e8, 1.0686e13,
          2.3539e17, 5.1847e21, 1.142e26, 2.5154e30, 5.5406e34,
        ]
      );
    });
  });
